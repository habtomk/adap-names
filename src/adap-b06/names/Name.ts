...
export interface Name extends Cloneable, Printable, Equality {
    ...
    /** Returns a new Name instance with the component set */
    setComponent(i: number, c: string): Name;

    /** Returns a new Name instance with the component inserted */
    ...
    /** Returns a new Name instance with the other name's components concatenated */
    concat(other: Name): Name;
    
    /** Returns a shallow copy (new instance) of this Name */
    clone(): Name;
}